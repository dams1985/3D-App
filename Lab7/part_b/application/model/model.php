...
class Model {
	...
	public function __construct()
	{
		...
		/*try {
		    $dsn = 'sqlite:./db/test1.db';
		    $pdo = new PDO($dsn);
		    // Database is created if it does not exist and a connection is made
	...
	public function dbCreateTable() {
        try {
            $this->dbhandle->exec("CREATE TABLE IF NOT EXISTS Model_3D (
            ...
            echo "Model_3D table is successfully created inside test1.db file";
        } catch (PDOException $e) {
	...
	public function dbInsertData()
	{
		...
		try{
			...
			"INSERT INTO Model_3D (Id, x3dModelTitle, x3dCreationMethod, modelTitle, modelSubtitle, modelDescription) 
				VALUES (1, 'X3D Coke Model', 'Method: Blender', 'Title: Coke 3D','Coke model subtitle','Coke model description'); " .
			"INSERT INTO Model_3D (Id, x3dModelTitle, x3dCreationMethod, modelTitle, modelSubtitle, modelDescription) 
				VALUES (2, 'X3D Sprite Model', 'Method: Blender', 'Title: Sprite 3D','Sprite model subtitle','Sprite model description'); " .
			"INSERT INTO Model_3D (Id, x3dModelTitle, x3dCreationMethod, modelTitle, modelSubtitle, modelDescription) 
				VALUES (3, 'X3D Pepper Model', 'Method: Blender', 'Title: Pepper 3D','Pepper model subtitle','Pepper model description'); ");
